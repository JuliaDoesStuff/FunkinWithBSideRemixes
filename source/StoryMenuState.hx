...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		sprDifficulty.animation.addByPrefix('beasy', 'BEASY');
		sprDifficulty.animation.addByPrefix('bnormal', 'BNORMAL');
		sprDifficulty.animation.addByPrefix('bhard', 'BHARD');
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		switch (curDifficulty)
		{
			...
			case 2:
				...
				sprDifficulty.offset.x = 20;
			case 3:
				sprDifficulty.animation.play('beasy');
				sprDifficulty.offset.x = 70;
			case 4:
				sprDifficulty.animation.play('bnormal');
				sprDifficulty.offset.x = 70;
			case 5:
				sprDifficulty.animation.play('bhard');
				sprDifficulty.offset.x = 70;
		}
