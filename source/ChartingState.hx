...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function loadSong(daSong:String):Void
	{
		...
		if (difficulty > 2)
			FlxG.sound.playMusic('assets/music/' + daSong + "_Inst_BSide" + TitleState.soundExt, 0.6);
		else
			FlxG.sound.playMusic('assets/music/' + daSong + "_Inst" + TitleState.soundExt, 0.6);

		// WONT WORK FOR TUTORIAL OR TEST SONG!!! REDO LATER
		if (difficulty > 2)
			vocals = new FlxSound().loadEmbedded("assets/music/" + daSong + "_Voices_BSide" + TitleState.soundExt);
		else
